...
import { columnMargin, CatTableColumn } from 'components/Table';
...
//         // }
//         const { column, protoColumn, labelColumn: groupByColumn, layout, focusedCategory } = this.props;
...
//     getSankeyBins() {
//         const { column, labelColumn: groupByColumn, focusedCategory } = this.props;
//         const x = this.getXScale();
